...
import numpy as np
import torch
from fairseq.data import Dictionary, ReplacementDictionary, data_utils
from torch.utils.data import dataset

from . import BaseWrapperDataset, LRUCacheDataset


class SupervisedMaskTokensDataset(BaseWrapperDataset):
    """
    ...
    Args:
        ...
        mask_id_list: Ids of mask tokens in vocab
    ...
    def __init__(
        ...
        self.mask = mask_dict
        # self.mask_sym_list = mask_dict.symbols[4:]
        # self.mask_id_list = [self.vocab.add_symbol(sym) for sym in self.mask_sym_list]
    ...
    def __getitem_cached__(self, seed: int, epoch: int, index: int):
        with data_utils.numpy_seed(self.seed, self.epoch, index):
            ...
            # print(mask[0], len(mask), len(new_item))
            new_item[mask] = toks[mask]
